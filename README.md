...
| Daily 06:15 ET | SoldScope Rank Tracker | Reuse-only GET of existing hero RT groups → daily `as_of` columns (never create groups/phrases; ready ~07:00 ET) |
