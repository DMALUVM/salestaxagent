...
ALTER TABLE IF EXISTS public.shopify_funnel_daily     ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.ga4_sessions_daily       ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.ga4_landing_daily        ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.google_ads_daily         ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.meta_ads_daily           ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.gsc_query_daily          ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.gsc_page_daily           ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.conversion_digest_status ENABLE ROW LEVEL SECURITY;
