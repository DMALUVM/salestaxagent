...
| soldscope_daily_rt | daily 10:30 | SoldScope Rank Tracker reuse-only GET of existing hero groups + phrases/v2 heatmap history → `soldscope_rank_snapshots` (never create groups/phrases) |
