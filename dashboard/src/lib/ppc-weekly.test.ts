...
import {
  BLAKE_63D_ACCOUNT_CVR,
  BLAKE_63D_WINDOW_CHIP,
  BLAKE_63D_WINDOW_LABEL,
  buildBlake63dList,
...
describe("90d helper still empty — this week is the 63d Blake list", () => {
  test("Jun 30–Aug 31 is 63d; 90d gate stays for later Mondays", () => {
    ...
    assert.equal(isExecuteWindowReady(63), false);
  ...
  test("emptyWeeklyList still ships zero rows (next-Monday helper)", () => {
    const short = emptyWeeklyList({
      search: storedWindow(["2026-06-30", "2026-08-31"]),
      account_cvr: 26.89,
      click_floor: 10,
    });
...
describe("Blake 63d execute list", () => {
  const lookup = {
    campaigns: [
      { campaign_id: "193871638584961", campaign_name: "GG - Deodorant - Exact - SQR - CST" },
      { campaign_id: "256130024359061", campaign_name: "GG - B0CLHYY3BB - Deodorant - Asin Defense" },
      { campaign_id: "16665771966353", campaign_name: "GG - SP - KW - Tallow Balm - B0CLF5B27Y - Exact 4" },
      { campaign_id: "167075799532625", campaign_name: "GG - Lip Balm - Asin Offense - Lip Balm Category" },
      { campaign_id: "268200579793067", campaign_name: "GG - Deodorant - Exact - Low Volume" },
      { campaign_id: "246697339798504", campaign_name: "SP - KW - Exact - Tallow Balm - B0CLF5B27Y - MAG" },
      { campaign_id: "239881499201970", campaign_name: "GG - Lip Balm - Broad M" },
      { campaign_id: "174708076680172", campaign_name: "SP - Auto - Deodorant - B0CLHYY3BB -" },
      { campaign_id: "131417227537954", campaign_name: "GG - Lip Balm - Exact - SQR - Long/Low" },
      { campaign_id: "261750837672497", campaign_name: "GG - SP - KW - Tallow Balm - B0CLF5B27Y - Exact 2" },
      { campaign_id: "401769304051792", campaign_name: "SP KW - Exact(PM) - Lip Balm - DPB0CLHTKY3V/B0CLHVLG2F -" },
      { campaign_id: "265530099680823", campaign_name: "SP KW - ISO - Lip Balm - organic lip balm" },
      { campaign_id: "209616848808384", campaign_name: "SP - 1KW(900kSV/ROS-PP) - Exact - Lip Balm - B0CLHTKY3V - -lip balm organic" },
      { campaign_id: "131099610631397", campaign_name: "GG - Deodorant - Asin Offense 3" },
      { campaign_id: "14597044311746", campaign_name: "GG - Lip Balm - Exact - Tallow Balm related KW - TOS" },
      { campaign_id: "10892789463718", campaign_name: "GG - Lip Balm - Exact - ChapStick related" },
      { campaign_id: "203560398305186", campaign_name: "GG - Lip Balm - Exact - Untargeted" },
      { campaign_id: "212191849663644", campaign_name: "GG - Lip Balm - Exact - SQR - Untargeted 2" },
      { campaign_id: "134972807416543", campaign_name: "SP - KW - Men's Deodorant - Phrase - Deodorant - B0CLHYY3BB -" },
    ...
    terms: [
      { search_term: "deodorant men", campaign_id: "193871638584961", campaign_name: "GG - Deodorant - Exact - SQR - CST", ad_group_name: "Exact", keyword: "deodorant men", match_type: "EXACT", clicks: 96, spend: 113.18, sales: 0 },
      { search_term: "carpe deodorant", campaign_id: "256130024359061", campaign_name: "GG - B0CLHYY3BB - Deodorant - Asin Defense", ad_group_name: "Asin Defense", clicks: 42, spend: 78.66, sales: 0 },
      { search_term: "beef tallow moisturizer", campaign_id: "16665771966353", campaign_name: "GG - SP - KW - Tallow Balm - B0CLF5B27Y - Exact 4", ad_group_name: "Exact", keyword: "beef tallow moisturizer", match_type: "EXACT", clicks: 31, spend: 59.40, sales: 0 },
      { search_term: "organic lip balm", campaign_id: "401769304051792", campaign_name: "SP KW - Exact(PM) - Lip Balm - DPB0CLHTKY3V/B0CLHVLG2F -", ad_group_name: "Exact NonBranded SSG", keyword: "organic lip balm", match_type: "EXACT", clicks: 858, spend: 1547.08, sales: 2584.65 },
      { search_term: "organic lip balm", campaign_id: "265530099680823", campaign_name: "SP KW - ISO - Lip Balm - organic lip balm", ad_group_name: "ISO", keyword: "organic lip balm", match_type: "EXACT", clicks: 10, spend: 20, sales: 40 },
      { search_term: "lip moisturizer for very dry lips", campaign_id: "203560398305186", campaign_name: "GG - Lip Balm - Exact - Untargeted", ad_group_name: "Exact", keyword: "lip moisturizer for very dry lips", match_type: "EXACT", clicks: 102, spend: 187.53, sales: 195.86 },
      { search_term: "non toxic mens deodorant", campaign_id: "134972807416543", campaign_name: "SP - KW - Men's Deodorant - Phrase - Deodorant - B0CLHYY3BB -", ad_group_name: "B0CLHYY3BB", keyword: "non toxic mens deodorant", match_type: "PHRASE", clicks: 44, spend: 64.83, sales: 31.98 },
      { search_term: "b0f7zfzd9z", campaign_id: "118866948630084", campaign_name: "SP - ASIN - COMP - Exact - Tallow Deodorant - B0CLHYY3BB -", ad_group_name: "B0CLHYY3BB", clicks: 68, spend: 128.66, sales: 15.99 },
      { search_term: "tallow balm for face", campaign_id: "261750837672497", campaign_name: "GG - SP - KW - Tallow Balm - B0CLF5B27Y - Exact 2", ad_group_name: "Exact", keyword: "tallow balm for face", match_type: "EXACT", clicks: 14, spend: 28.48, sales: 0 },
    ],
    placements: [],
  };

  const list = buildBlake63dList({ lookup });

  test("not empty; window is 63d Jun 30–Aug 31, not 90d or 24d", () => {
    assert.equal(list.execute_list, "blake_63d");
    assert.equal(list.execute_ready, true);
    assert.equal(list.rows.length, 23);
    assert.equal(list.window.search.label, BLAKE_63D_WINDOW_LABEL);
    assert.equal(list.window.search.days, 63);
    assert.equal(list.window.search.days_with_rows, 23);
    assert.equal(list.window_chip, BLAKE_63D_WINDOW_CHIP);
    assert.match(list.notes[0], /63d Blake-ranked list/);
    assert.match(list.notes[0], /23 days with rows/);
    assert.match(list.notes[0], /SP-only/);
    assert.doesNotMatch(list.window.search.label, /90d|24d/);
    assert.equal(list.account_cvr_branded, 41.26);
    assert.equal(list.account_cvr_nonbranded, 25.79);
    assert.equal(list.click_floor, 10);
    assert.equal(list.account_cvr, BLAKE_63D_ACCOUNT_CVR);
    assert.equal(list.grok_prompt, WEEKLY_GROK_PROMPT_63D);
    assert.match(list.grok_prompt, /2026-06-30\.\.08-31 \(63d/);
    assert.doesNotMatch(list.grok_prompt, /2026-08-06\.\.08-29 \(24d\)/);
    assert.doesNotMatch(list.grok_prompt, /Wait for ads_search_terms_daily/);
    for (const r of list.rows) {
      assert.equal(r.current_bid, null);
      assert.equal(r.window, BLAKE_63D_WINDOW_LABEL);
      assert.doesNotMatch(r.window, /90d|24d/);
    }
  });

  test("open rows stay in Blake order", () => {
    assert.deepEqual(list.rows.map((r) => r.term), [
      "deodorant men",
      "carpe deodorant",
      "beef tallow moisturizer",
      "dr dans cortibalm lip balm",
      "vanmans deodorant",
      "beef tallow and honey balm",
      "coconut oil lip balm",
      "wild deodorant",
      "goats milk chapstick",
      ...
      "non toxic mens deodorant",
      "b0f7zfzd9z",
    ]);
  });

  test("pause_keyword only on the three exact KW=term R1 rows", () => {
    const pauses = list.rows.filter((r) => r.action === "pause_keyword");
    assert.deepEqual(pauses.map((r) => r.term), [
      "deodorant men",
      "beef tallow moisturizer",
    ...
    assert.ok(pauses.every((r) => r.sales === 0));
    const vanmans = list.rows.find((r) => r.term === "vanmans deodorant");
    assert.equal(vanmans?.action, "negative_exact");
    const goats = list.rows.find((r) => r.term === "goats milk chapstick");
    assert.equal(goats?.action, "negative_exact");
  });

  test("24d pause/negate rows that sold in 63d are bid_down", () => {
    const dry = list.rows.find((r) => r.term === "lip moisturizer for very dry lips");
    const natural = list.rows.find((r) => r.term === "chapstick natural");
    const phrase = list.rows.find((r) => r.term === "non toxic mens deodorant");
    assert.equal(dry?.action, "bid_down");
    assert.ok((dry?.sales ?? 0) > 0);
    assert.equal(natural?.action, "bid_down");
    assert.ok((natural?.sales ?? 0) > 0);
    assert.equal(phrase?.action, "bid_down");
    assert.equal(phrase?.match_type, "PHRASE");
  });

  test("organic lip balm / lip balm organic are bid_down on the Exact PM row only", () => {
    const organic = list.rows.filter((r) => r.term === "organic lip balm");
    const organic2 = list.rows.find((r) => r.term === "lip balm organic");
    assert.equal(organic.length, 1);
    assert.equal(organic[0]?.action, "bid_down");
    assert.equal(organic[0]?.campaign_id, "401769304051792");
    assert.equal(organic2?.action, "bid_down");
    assert.equal(list.rows.filter((r) => /organic lip balm|lip balm organic/i.test(r.term) && r.action === "pause_keyword").length, 0);
    assert.equal(list.rows.some((r) => r.campaign_id === "265530099680823"), false);
  });

  test("b0f7zfzd9z is negative_exact despite 1 order; no TOS / excluded terms", () => {
    const asin = list.rows.find((r) => r.term === "b0f7zfzd9z");
    assert.equal(asin?.action, "negative_exact");
    assert.equal(asin?.sales, 15.99);
    assert.equal(list.rows.filter((r) => r.action === "raise_tos").length, 0);
    assert.equal(list.rows.filter((r) => r.action === "cut_detail_page").length, 0);
    for (const r of list.rows) {
      assert.doesNotMatch(r.term, /primal essence/i);
      assert.doesNotMatch(r.term, /beef tallow chapstick/i);
      assert.doesNotMatch(r.term, /tallow chapstick organic/i);
      assert.doesNotMatch(r.term, /aquaphor/i);
    }
  });

  test("resolver fills unique campaign ids; Exact 2 vs Exact 4 stay distinct", () => {
    const deo = list.rows.find((r) => r.term === "deodorant men");
    assert.equal(deo?.campaign_id, "193871638584961");
    const exact4 = list.rows.find((r) => r.term === "beef tallow moisturizer");
    assert.equal(exact4?.campaign_id, "16665771966353");
    const exact2 = list.rows.find((r) => r.term === "tallow balm for face");
    assert.equal(exact2?.campaign_id, "261750837672497");
    const untargeted = list.rows.find((r) => r.term === "lip moisturizer for very dry lips");
    assert.equal(untargeted?.campaign_id, "203560398305186");
  });

  test("CSV export includes the ranked 63d window", () => {
    const csv = weeklyToCsv(list.rows);
    assert.match(csv, /deodorant men/);
    assert.match(csv, /organic lip balm/);
    assert.match(csv, /b0f7zfzd9z/);
    assert.match(csv, /2026-06-30\.\.08-31 \(63d\)/);
    assert.doesNotMatch(csv, /90d/);
    assert.doesNotMatch(csv, /\(24d\)/);
  });

  test("Done/Skipped lock applies without reopening sold rows", () => {
    const locked = buildBlake63dList({
      lookup,
      now: new Date("2026-09-01T12:00:00.000Z"),
      decisions: [{
        campaign_id: "401769304051792",
...
describe("cadence + HOLD live in copy, not extra pages", () => {
  test("24d execute Grok prompt is the execute list; does not wait for 90d", () => {
    ...
    assert.doesNotMatch(WEEKLY_GROK_PROMPT_63D, /2026-08-06\.\.08-29 \(24d\)/);
  });
