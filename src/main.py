...
_SCHEDULER = None
# HTTP 425 (Amazon slot busy) uses one replaceable date-trigger.
# Lease-busy uses one after-release retry instead — 20-minute polls used
# to write a skip row every cycle while campaigns held the lock for hours.
_ADS_RETRY_MAX = 1
